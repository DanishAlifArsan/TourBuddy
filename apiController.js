...
exports.getDestinationByCoordinates = (req, res) => {
...
exports.getReviewsByDestinationId = (req, res) => {
...
exports.addReview = (req, res) => {
    ...
    const newReview = {
        reviewer_name: "Anonymous", // This could be replaced with actual user data if authentication is implemented
        review: review,
        rating: rating,
